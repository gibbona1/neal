instruction_list <- list(
     list("str" = "This is the main page. To start, click the user icon on the top right.",
          "img" = 'app_1main.png'),
     list("str" = "Click the green Start Labelling button to load the first file.",
          "img" = 'app_2start.png'),
     ...
     list('str'="To save your selection as an annotation/label:",
          ...
          list('str' = "Click ``Save Selection`` to label the selection as the chosen species.",
               'img' = 'app_5bselection_saved.png')
          ),
     list('str'="To add an extra species to the list of classes:",
          list('str'="Type the species into the *Type in additional category* box",
               'img' = 'app_6typespecies.png'),
          list('str'="Press enter or click the *Add* button below ",
     ...
     list('str'="To investigate a selection further:",
          ...
          list('str' = "Open the *FFT Settings* drowpdown menu",
               'img' = 'app_7cfftsettings.png'),
          list('str' = "Increase the *FFT Overlap for display spectrogram (%)* parameter. The spectrogram will then reload with a better resolution",
